...
@;		16+:	gelatina doble (a sumarle código de elemento)
	...
	@; mapa 1: paredes horizontales y verticales
		...
		.byte 1,2,3,3,4,3,7,1,15
		.byte 1,2,7,5,1,7,7,1,15
		.byte 4,1,1,2,8,1,7,1,15
		.byte 1,4,4,2,6,3,7,1,15
		.byte 4,2,2,5,2,2,7,1,15
		.byte 4,5,5,2,5,5,7,1,15
		.byte 7,1,1,5,4,6,1,1,15
		.byte 1,2,1,2,1,2,1,2,1

	@; mapa 2: huecos y bloques sólidos
		.byte 15,15,7,15,15,7,15,15,15
		.byte 1,2,3,3,4,3,7,1,15
		.byte 1,2,7,5,1,7,7,1,15
		.byte 4,16,1,2,3,1,7,1,15
		.byte 1,4,4,2,6,3,7,1,15
		.byte 4,2,2,5,2,2,7,1,15
		.byte 4,5,5,2,5,5,7,1,15
		.byte 7,1,1,5,4,6,1,1,15
	...
	@; mapa 7: combinaciones cruzadas (hor/ver) de 5, 6 y 7 elementos
		.byte 15,15,7,15,15,7,15,15,15
		.byte 1,2,3,3,4,3,7,1,15
		.byte 1,2,7,5,3,7,7,1,15
		.byte 4,1,1,2,3,8,7,1,15
		.byte 1,4,4,2,6,3,7,1,15
		.byte 4,2,2,5,2,2,7,1,15
		.byte 4,5,5,2,5,5,7,1,15
		.byte 7,1,1,5,4,6,1,1,15
		.byte 1,1,1,1,1,1,1,1,15
