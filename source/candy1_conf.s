...
@;		16+:	gelatina doble (a sumarle código de elemento)
	...
	@; mapa 6: combinaciones en vertical
		.byte 1,3,4,1,5,6,2,15,15
		.byte 2,5,1,4,2,5,7,15,15
		.byte 1,3,4,4,2,5,15,7,15
		.byte 2,5,4,2,6,15,2,7,15
		.byte 5,3,1,15,6,6,5,7,15
		.byte 2,7,4,3,5,15,6,7,15
		.byte 5,7,15,6,6,5,6,7,7
		.byte 7,15,15,7,7,5,6,7,15
		.byte 15,15,7,15,15,5,7,15,15
	@; mapa 5: combinaciones en horizontal
		.byte 1,2,1,15,2,1,2,2,7
		.byte 3,5,3,6,3,15,7,7,15
		.byte 4,1,4,3,4,4,15,7,15
		.byte 1,4,4,2,6,3,7,0,15
		.byte 5,2,2,15,5,2,5,1,5
		.byte 6,5,5,2,5,6,6,2,15
		.byte 15,7,6,1,6,7,7,7,7
	...
	@; mapa 7: combinaciones cruzadas (hor/ver) de 5, 6 y 7 elementos
		...
		.byte 2,2,1,3,4,3,7,0,15
		.byte 1,2,7,5,3,7,7,0,15
		.byte 4,1,6,2,1,8,7,0,15
		.byte 1,4,6,2,6,3,7,0,15
		.byte 4,2,3,3,2,2,7,0,15
		.byte 6,5,5,2,5,5,7,0,15
